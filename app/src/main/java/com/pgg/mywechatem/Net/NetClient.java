package com.pgg.mywechatem.Net;
...
public class NetClient {
	...
	// Imageload缓存目录
	private static File cacheDir = new File(BaseApplication.getHJYCacheDir() + "/Imageload");
	...
	static {
		...
		ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(BaseApplication.getBaseApplication()).threadPoolSize(10)
